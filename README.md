...
| **请求点** (logistics-request-point, 2x2) | 贴图采用**原版单位物流卸载点（Unit Cargo Unload Point）**，并**像原版一样用所选物品的颜色显示在方块上**，选中的物品会被无人机持续运来直到装满（容量 240）。**会自动向周围输出物品**。**可以设置优先级**，货物会优先运往高优先级请求点 |
